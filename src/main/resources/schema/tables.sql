...
CREATE TABLE user(
  ...
  degree TINYINT NOT NULL -- 2普通职员 3部门负责人 4管理员 5单位领导
)CHARSET = utf8;
...
CREATE TABLE article(
  ...
  department_pass_user VARCHAR(20),
  unit_pass int,
  unit_review TEXT,
  unit_pass_user VARCHAR(20),
  secret int
)CHARSET =utf8;
